# PROGRESS — Archiwum (Learning Loop)

Zarchiwizowane wpisy z handoff logu (od najnowszych do najstarszych). Aktualne wpisy są w [PROGRESS.md](../PROGRESS.md). Przeniesione 2026-06-14, by utrzymać główny plik pod 200 linii. Kolejna partia (2026-05-31, 2026-05-21) przeniesiona 2026-06-16 po backfillu wpisu 2026-06-15.
...
> _Uwaga (kontekst po fakcie): model „generate-audit" opisany wyżej został zastąpiony 2026-06-15
> przez self-graded recall bez AI — zob. wpis 2026-06-15 w głównym PROGRESS.md._
...
- **6 callsite'ów zmigrowanych** na `completeWithTool` z lokalnymi `ToolDefinition` (JSON schema obok zod schemy — zod nadal waliduje belt-and-suspenders):
  ...
  - [lib/ai/generate-audit.ts](../lib/ai/generate-audit.ts) — `submit_audit_questions` _(plik usunięty w redesignie 2026-06-15)_
